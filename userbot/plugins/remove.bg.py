...
async def _(event):
    ...
    if "image" in contentType:
        ...
        await event.edit("Removed dat annoying Backgroup in {} seconds, powered by @thedemonhub".format(ms))
    else:
        await event.edit("ReMove.BG API returned Errors. Please report to @thedemonhub\n`{}".format(output_file_name.content.decode("UTF-8")))
